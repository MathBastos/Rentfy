...
import com.puc.project.rentify.model.JoinImovel;
...
public class ImovelController {
    ...
    public List<Imovel> listar() throws InterruptedException, ExecutionException {
        return repository.listar();
    }

    @Operation(summary = "Listagem de Imóveis com joins")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Listagem de Imóveis com joins")
    })
    @GetMapping("/listar_join")
    @ResponseStatus(HttpStatus.OK)
    public List<JoinImovel> listar_join() throws IdNotFound, InterruptedException, ExecutionException {
        return repository.listar_join();
    }

    @Operation(summary = "Listar Imóvel por ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Imóvel do respectivo ID"),
            @ApiResponse(responseCode = "404", description = "ID não encontrado", content = @Content)
    })
    @GetMapping("/listar_id")
    @ResponseStatus(HttpStatus.OK)
    public Imovel listar(@RequestParam String id) throws InterruptedException, ExecutionException {
        try {
    ...
    @Operation(summary = "Listar Imóvel por ID com joins")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Imóvel do respectivo ID com joins."),
            @ApiResponse(responseCode = "404", description = "ID não encontrado", content = @Content)
    })
    @GetMapping("/listar_join_id")
    @ResponseStatus(HttpStatus.OK)
    public JoinImovel listar_join(@RequestParam String id) throws InterruptedException, ExecutionException {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Imóvel criado", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Imovel.class))}),
    ...
    public Map<String, String> adicionar(@RequestBody Imovel obj) throws InterruptedException, ExecutionException {
        try {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Imóvel alterado", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = Imovel.class))}),
            @ApiResponse(responseCode = "404", description = "ID / ID Estrangeiro não encontrado", content = @Content)
    })
    @PutMapping("/alterar")
    @ResponseStatus(HttpStatus.OK)
    public Map<String, String> alterar(@RequestBody Imovel obj) throws InterruptedException, ExecutionException {
        try {
